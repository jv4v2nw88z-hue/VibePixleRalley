...
var SPECS = {
  hatch: {
    pw:19, ph:33,
    hw:[[0,5.4],[0.05,6.6],[0.13,7.8],[0.30,8.2],[0.62,8.2],[0.84,8.0],[0.94,7.2],[1,5.8]],
    hood:[0.09,0.34], screen:[0.32,0.44], roof:[0.43,0.66], rear:[0.65,0.76], boot:[0.76,0.92],
    axleF:0.20, axleR:0.80, wheelL:0.155, wheelW:2.6, arch:1.0,
    hoodVent:0, roofVent:1, spoiler:0.55, mirror:0.36, lightBar:0
  },
  rally: {
    pw:21, ph:35,
    hw:[[0,6.0],[0.05,7.4],[0.12,8.8],[0.28,9.2],[0.62,9.2],[0.85,9.0],[0.95,8.0],[1,6.4]],
    hood:[0.08,0.33], screen:[0.31,0.43], roof:[0.42,0.65], rear:[0.64,0.75], boot:[0.75,0.91],
    axleF:0.19, axleR:0.80, wheelL:0.16, wheelW:3.0, arch:1.4,
    hoodVent:1, roofVent:1, spoiler:0.80, mirror:0.35, lightBar:0
  },
  wrc: {
    pw:23, ph:36,
    hw:[[0,6.8],[0.04,8.4],[0.11,10.0],[0.26,10.4],[0.62,10.4],[0.86,10.2],[0.96,9.0],[1,7.2]],
    hood:[0.08,0.32], screen:[0.30,0.42], roof:[0.41,0.64], rear:[0.63,0.74], boot:[0.74,0.90],
    axleF:0.19, axleR:0.80, wheelL:0.165, wheelW:3.4, arch:1.9,
...
function buildBuffer(spec, pal, livery, liveryAt, dmg){
  ...
  set(cx-2, s0, pal.chromeDark); set(cx+1, s0, pal.chromeDark);
  ...
  if(spec.roofVent){
    ...
    for(var rv=0; rv<spec.roofVent; rv++){
      ...
      for(var rx=-2; rx<=2; rx++){
        set(cx+rx, ry2, pal.vent);
        set(cx+rx, ry2+1, pal.black);
      }
    }
  }
